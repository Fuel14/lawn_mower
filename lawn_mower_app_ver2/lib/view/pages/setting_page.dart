...
class _SettingPageState extends State<SettingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Bluetooth Device Select')),
      body: ListView(
        children: [
          const Divider(),
                ...
                onTap: () async {
                  ...
                  try {
                    ...
                    if (connection != null && connection.isConnected) {
                      ...
                      bluetoothDeviceAdressNotifier.value = connection;
                      bluetoothDeviceDataNotifier.value = result;
                      bluetoothDeviceConnectingStatusNotifier.value = true;
